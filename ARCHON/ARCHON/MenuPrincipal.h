...
public:
    ...
    void procesarEntrada(sf::RenderWindow& ventana, MotorArchon* motor) override;//procesa las entradas(clicks) del usuario y actualiza el menu, banderas,fondo,color de botones
