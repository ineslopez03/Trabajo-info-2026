...
public:
    ...
    Pieza* getGanador() {
        return (piezaIzquierda->getVidaBase() > 0) ? piezaIzquierda : piezaDerecha;
    } //si el izq tiene vida mayor a 0 gana, si no gana el der
    Pieza* getPerdedor() {
        return (piezaIzquierda->getVidaBase() <= 0) ? piezaIzquierda : piezaDerecha;
    } //si el izq tiene 0 de vida pierde, si no pierde el der
